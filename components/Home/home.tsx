...
const Home = () => {
  return (
    <div
      id="home"
      className=" min-h-screen bg-gradient-to-b from-teal-200 to-white flex  items-center justify-center pt-20  pb-10 lg:pb-0 px-4"
    >
      <div className="  md:mx-0 lg:mx-32 flex flex-col  lg:flex-row  items-center justify-between gap-12 md:gap-4 ">
        <div className="text-center max-w-lg w-full mx-auto sm:text-center">
          ...
          <Link href="/form" >
        <button
          className="mt-6 px-6 p-3   bg-orange-500 text-white rounded-full shadow-lg hover:bg-orange-600 transition-all text-base sm:text-lg md:text-xl "
        >
          Start your Project →
        </button>
      </Link>
